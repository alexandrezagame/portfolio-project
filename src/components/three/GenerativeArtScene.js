...
export function GenerativeArtScene({ className = '', color = '#ff8a32' }) {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e) => {
      if (!lightRef.current || !material) return;
      ...
      if (material.uniforms && material.uniforms.pointLightPos) {
    ...
    return () => {
      ...
      if (sceneRef.current) {
        ...
        if (sceneRef.current.mesh && sceneRef.current.mesh.geometry) {
