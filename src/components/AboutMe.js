    ...
    <div id="about" className="container py-5">
      <div className="row">
        ...
        <div className="col-lg-6 col-xm-12">
          ...
          <p>
            I’m a French-Uruguayan citizen living in Stockholm with a passion for
          ...
          <p>
            I have international work experience in Sweden, Switzerland, France, Spain
            and Brazil. Moreover I am passionate about photography and voice
            acting.
          </p>
        </div>
      </div>
